...
public class AddStudentActivity extends Activity {
    ...
    private EditText textFirstName, textLastName, textcontact, textaddress;
    private Spinner spinnerbranch, spinneryear;
    private String userrole, branch, year;
        ...
        registerButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(first_name)) {
                    ...
                    Intent intent = new Intent(AddStudentActivity.this, AdminMenuActivity.class);
