package com.rajnikant.dell.attendancemanagement.BeanClass;
...
public class AttendanceSessionBean {
    ...
    public String getAttendance_session_faculty_name() {
        return attendance_session_faculty_name;
    }

    public void setAttendance_session_faculty_name(String attendance_session_faculty_name) {
        this.attendance_session_faculty_name = attendance_session_faculty_name;
    }

    private String attendance_session_faculty_name;
